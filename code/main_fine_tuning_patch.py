...
from albumentations import (
    ...
    IAASharpen, IAAEmboss, RandomContrast, RandomBrightness, Flip, OneOf, Compose, ToGray
)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for data in tqdm(dset_loaders[phase]):
                ...
                patch1 = inputs[:,:,0:112, 0:112]
                patch2 = inputs[:,:,0:112, 113:]
                patch3 = inputs[:,:,113:, 0:112]
                patch4 = inputs[:,:,113:, 113:]

                optimizer.zero_grad()
                outputs = model(patch1, patch2, patch3, patch4)
...
# model_ft = pretrainedmodels.resnext101_64x4d(num_classes=1000, pretrained='imagenet')
...
# Save model
torch.save(model_ft.state_dict(), 'best_model_resnext64_cutout_aug.pt')
