...
# model = pretrainedmodels.nasnetamobile(num_classes=1000)
...
model.load_state_dict(torch.load('best_model_squeeze1_1_cutout_aug.pt'))
model.cuda()
model.eval()
...
output = open('../dumps/dump_squeeze1_1_cutout_aug.pkl', 'wb')
